(function ($) {
	...
	class Silence {
		...
		getMainMode() {
			...
			document.addEventListener('visibilitychange', function () {
				if (document.visibilityState == 'hidden') {
					clearTimeout(time);
					document.title = '你别走！(っ °Д °;)っ';
				} else {
					document.title = '你回来了(●ˇ∀ˇ●)';
		...
		buildCustomElements() {
			...
			$title.html($title.html().replace(`Snow | ${autherName}`, `${blogTitle}`));
			...
			$("#navList").append('<li><a id="blog_nav_myhome" class="menu" href="https://www.cnblogs.com/Areds">首页</a><i></i></li><li><a id="blog_nav_myyoulian" class="menu" href="https://www.cnblogs.com/Areds/p/12114820.html">友人帐</a><i></i></li><li><a id="blog_nav_contact" class="menu" href="https://www.cnblogs.com/Areds/p/12114815.html">留言板</a><i></i></li><li><a id="blog_nav_rss" class="menu" href="https://www.cnblogs.com/Areds/p">归档</a><i></i></li><li><a id="blog_nav_myguanyu" class="menu" href="">关于</a><i></i></li>');
			//添加标签icon
			...
			let guanyu = '<ul class="sub-menu">' +
					'<li><a href="https://www.cnblogs.com/Areds/p/12114780.html"><i class="fa fa-meetup" aria-hidden="true"></i>Me?</a></li>' +
					'<li><a href="https://www.cnblogs.com/Areds/p/12114810.html"><i class="fa fa-area-chart" aria-hidden="true"></i>公告</a></li>' +
					'<li><a href="https://www.cnblogs.com/Areds/p/12114807.html"><i class="fa fa-heartbeat" aria-hidden="true"></i>推荐</a></li>' +
					'<li><a href="https://www.cnblogs.com/Areds/p/12114830.html"><i class="iconfont icon-taohua" aria-hidden="true"></i>更多</a></li>' +
					'</ul>';
		...
		buildCopyright() {
            ...
            Theme <a href="https://github.com/Zou-Wang/CNblogs-Theme-Sakura" target="_blank">Areds v${this.version}</a></div>`;
		...
		buildToolbar() {
			...
			$('body').append(`<div class="esa-toolbar">
                <!--<button class="esa-toolbar-gotop"><div class="tips">Top</div></button>-->
                <!--<button class="esa-toolbar-contents"><div class="tips">Reading List</div></button>-->
                <button class="esa-toolbar-follow">Catch</button>
            </div>`);
		...
		buildBloggerProfile() {
			...
			var title = '<div class="site-branding">' +
					...
					'<a href="https://www.cnblogs.com/Areds/" alt="Areds">' +
					'<ruby><span class="sakuraso">31</span><span class="no">の</span><span class="shironeko">Areds</span>' +
					'<rt class="chinese-font">31班的Areds</rt></ruby></a></span>' +
					'</div>'
			$('body').prepend(title);
		...
		setHomeSuiBiList() {
			...
			for (let i = article_list.length - 1; i >= 0; i--) {
				...
				let postTitle = $('.day').find('div.postTitle')[i].innerHTML;//<a class="postTitle2" href="https://www.cnblogs.com/Areds">Hey</a>
				...
				let desc = $('.day').find('div.postDesc')[i].textContent;//posted @ 2019-07-16 13:27 31のAreds 阅读 (3073) 评论 (56)<a href="https://i.cnblogs.com/EditPosts.aspx?postid=11194299" rel="nofollow">编辑</a>
				...
				let html = `<div class="post post-list-thumb post-list-show">` +
						...
						`     <div class="post-meta"> <span><i class="iconfont icon-attention"></i>${readNum} 热度</span> <span class="comments-number"><i class="iconfont icon-mark"></i>${comNum} 条评论</span> <span><i class="iconfont icon-cc-user"></i><a href="https://www.cnblogs.com/Areds"></a>${author}</span></div>` +
		...
		postHeader() {
			...
			if (window.location.href.indexOf('articles') === -1) {
				var header =
						`<p class="entry-census"><span><a href="https://www.cnblogs.com/Areds/"><img src="https://pic.cnblogs.com/avatar/1743713/20190913084704.png"></a></span><span><a href="https://www.cnblogs.com/Areds">Areds</a></span><span class="bull">·</span>${post_date}<span class="bull">·</span>${post_view_count} 次阅读</p>`;
